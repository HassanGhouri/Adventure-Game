...
public class Room implements Serializable {
    ...
    public final String adventureName;
    /**
    ...
    /**
     * The amount of health added to the player when the player enters the room.
     */
     ...
     */
    public Room(String roomName, int roomNumber, String roomDescription, double healthEffect, String adventureName){
    ...
    public String getCommands() {
        String out = "";
        for(Passage p : motionTable.getDirection()){
            if(!out.contains(p.getDirection())){
                out += p.getDirection() + ", ";
            }
        }
        return out.substring(0, out.length() - 2);
    ...
    /**
     * Getter method for the healthEffect attribute.
     *
     * @return: motion table of the room
     */
